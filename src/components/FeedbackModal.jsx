export default function FeedbackModal({ modal, onClose }) {
  return (
    ...
    >
      <div className="modal glass" role="dialog" aria-modal="true" aria-labelledby="modalTitle">
        <button className="modal-close" id="modalClose" aria-label="Fenster schließen" onClick={onClose}>
          ×
        </button>
        <div
        ...
        <p id="modalText">{modal.text || 'Hier erscheint deine Rückmeldung.'}</p>
